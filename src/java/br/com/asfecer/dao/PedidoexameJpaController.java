 ...
 * @author PToledo
 */
public class PedidoexameJpaController implements Serializable {

    public PedidoexameJpaController(UserTransaction utx, EntityManagerFactory emf) {
        this.utx = utx;
        this.emf = emf;
    }
    ...
    public void create(Pedidoexame pedidoexame) throws RollbackFailureException, Exception {
    ...
    public void edit(Pedidoexame pedidoexame) throws NonexistentEntityException, RollbackFailureException, Exception {
        EntityManager em = null;
        try {
            utx.begin();
            em = getEntityManager();
