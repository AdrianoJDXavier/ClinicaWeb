        ...
        <div class="main col-md-10 col-md-push-2">
            ...
            <div class="panel panel-default" style="margin:10px;">
                <div class="panel-heading">
                    <h3 class="panel-title">Cadastrar Médicos</h3>
                </div>
                <div class="panel-body">
                    ...
                    <form action="" method="POST"  style="margin: 15% 0;">
                        ...
                        <input class="form-control" type="text" name="nomeMedico" placeholder="Nome Completo do Médico" />
                        <div class="row">
                            <div class="col-md-4">
                                <label>CRM</label>
                                <input class="form-control" type="number" name="crm" placeholder="CRM do Médico" />
                            </div>
                            <div class="col-md-4">
                                <label>Especialidade</label>
                                <input class="form-control" type="text" name="especialidade" placeholder="especialidade" />
                            </div>
                            <div class="col-md-4">
