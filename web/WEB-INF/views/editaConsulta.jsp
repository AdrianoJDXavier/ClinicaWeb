                    ...
                    <form action="" method="POST"  style="margin: 10% 0;">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input class="form-control" type="date" name="dataConsulta" value="${consulta.dataconsulta}"/>
                            </div>
                            <div class="col-md-4">
                                <label>Hora</label>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <c:forEach var="medico" items="${medico}">
                                    <c:if test="${medico.idmedico == consulta.medico.idmedico}" >
                                        <option value="${medico.idmedico}" selected="">${medico.nomemedico}</option>
                                    </c:if>
                                    <c:if test="${medico.idmedico != consulta.medico.idmedico}" >
                        ...
                        <div class="col-md-6">
                            ...
                            <select class="form-control" name="paciente">
                                <c:forEach var="paciente" items="${paciente}">
                                    <c:if test="${paciente.idpaciente == consulta.paciente.idpaciente}">
                                        <option value="${paciente.idpaciente}" selected="">${paciente.nomepaciente}</option>
                                    </c:if>
                                    <c:if test="${paciente.idpaciente != consulta.paciente.idpaciente}">
                                        <option value="${paciente.idpaciente}" selected="">${paciente.nomepaciente}</option>
                                    </c:if>
